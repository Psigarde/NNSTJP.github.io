...
var CharactersDBNA = ["100001", "100069", "100070", "100071", "100079"];
var CharactersELE00 = ["100001"];
var CharactersELE01 = ["100003", "100007", "100010", "100012", "100019", "100020", "100022", "100023", "100030", "100034", "100041", "100044", "100046", "100052", "100055", "100069", "100077", "101007", "104012", "106019", "108002", "191002", "191018"];
var CharactersELE02 = ["100002", "100004", "100005", "100008", "100011", "100013", "100017", "100021", "100024", "100025", "100028", "100049", "100057", "100058", "100059", "100071", "100075", "102002", "104002", "107034", "191045", "191053"];
var CharactersELE03 = ["100006", "100014", "100018", "100027", "100029", "100032", "100033", "100035", "100036", "100038", "100039", "100040", "100043", "100048", "100053", "100060", "100063", "100070", "100074", "104053", "108007", "191044", "191056"];
var CharactersELE04 = ["100009", "100015", "100016", "100026", "100031", "100037", "100042", "100045", "100047", "100050", "100056", "100079", "191022"];
...
function SelectCharacter(ID)
	{
		...
		if(CharacterIDCurr.charAt(1) == "1")
			{
				Data.CharacterID[parseInt(CharacterIDCurr.charAt(3)) - 1] = ID;
			}
		else
			{
		...
		if(CharactersELE00.some(String => ID.includes(String)))
			{
				...
				document.getElementById("ID" + CharacterIDCurr + "Element").style.cursor = "pointer";
			}
		else
			{
				if(CharactersELE01.some(String => ID.includes(String)))
					{
						document.getElementById("ID" + CharacterIDCurr + "Element").src = "PNG/UI/ELE01.png";
					}
				else if(CharactersELE02.some(String => ID.includes(String)))
					{
						document.getElementById("ID" + CharacterIDCurr + "Element").src = "PNG/UI/ELE02.png";
					}
				else if(CharactersELE03.some(String => ID.includes(String)))
					{
						document.getElementById("ID" + CharacterIDCurr + "Element").src = "PNG/UI/ELE03.png";
					}
				else if(CharactersELE04.some(String => ID.includes(String)))
					{
						document.getElementById("ID" + CharacterIDCurr + "Element").src = "PNG/UI/ELE04.png";
					}
				else
					{
						document.getElementById("ID" + CharacterIDCurr + "Element").src = "PNG/UI/ELE00.png";
					}
				document.getElementById("ID" + CharacterIDCurr + "Element").style.cursor = "default";
			}
		DB("0101CharacterDB");
		Element("01IdoMagELE01");
	}
...
function SelectWeapon(ID)
	{
		...
		if(SymbolIDCurr.charAt(1) == "1")
			{
				Data.WeaponID[parseInt(SymbolIDCurr.charAt(3)) - 1] = ID;
			}
		else
			{
				Data.WeaponID[parseInt(SymbolIDCurr.charAt(3)) + 3] = ID;
			}
	}
function SelectSoul(ID)
	{
		...
		if(SymbolIDCurr.charAt(1) == "1")
			{
				Data.SoulID[parseInt(SymbolIDCurr.charAt(3)) - 1] = ID;
			}
		else
			{
				Data.SoulID[parseInt(SymbolIDCurr.charAt(3)) + 3] = ID;
			}
	}
...
function SelectIdoMag(ID)
	{
		...
		(IdoMagIDCurr == "01") ? Data.IdoMagID[0] = ID : Data.IdoMagID[1] = ID;
	}
		...
		for(var Count01 = 1; Count01 < 3; Count01 ++)
			{
				for(var Count02 = 1; Count02 < 5; Count02 ++)
					{
						document.getElementById("0" + Count01 + "0" + Count02 + "Character").style.border = "2px solid rgba(255, 64, 64, 0)";
						document.getElementById("0" + Count01 + "0" + Count02 + "Weapon").style.border = "2px solid rgba(255, 64, 64, 0)";
						document.getElementById("0" + Count01 + "0" + Count02 + "Soul").style.border = "2px solid rgba(255, 64, 64, 0)";
					}
				document.getElementById("0" + Count01 + "IdoMag").style.border = "2px solid rgba(255, 64, 64, 0)";
			}
	}
function LB(ID)
	{
		...
		for(var Count01 = 1; Count01 < 3; Count01 ++)
			{
				for(var Count02 = 1; Count02 < 5; Count02 ++)
					{
						Data.CharacterLB[(Count01 == 1) ? Count02 - 1 : Count02 + 3] = document.getElementById("0" + Count01 + "0" + Count02 + "CharacterLB").value;
					}
			}
		Element("01IdoMagELE01");
	}
...
function Element(ID)
	{
		...
		for(var Count01 = 1; Count01 < 3; Count01 ++)
			{
				var ELE01 = 1 + parseInt(document.getElementById("0" + Count01 + "IdoMagELE01").value);
				var ELE02 = 1 + parseInt(document.getElementById("0" + Count01 + "IdoMagELE02").value);
				var ELE03 = 1 + parseInt(document.getElementById("0" + Count01 + "IdoMagELE03").value);
				var ELE04 = 1 + parseInt(document.getElementById("0" + Count01 + "IdoMagELE04").value);
				for(var Count02 = 1; Count02 < 5; Count02 ++)
					{
						ELE01 += (document.getElementById("ID0" + Count01 + "0" + Count02 + "Element").src.includes("PNG/UI/ELE01.png")) ? (0.25 * parseInt(document.getElementById("0" + Count01 + "0" + Count02 + "CharacterLB").value)) : 0 ;
						ELE02 += (document.getElementById("ID0" + Count01 + "0" + Count02 + "Element").src.includes("PNG/UI/ELE02.png")) ? (0.25 * parseInt(document.getElementById("0" + Count01 + "0" + Count02 + "CharacterLB").value)) : 0 ;
						ELE03 += (document.getElementById("ID0" + Count01 + "0" + Count02 + "Element").src.includes("PNG/UI/ELE03.png")) ? (0.25 * parseInt(document.getElementById("0" + Count01 + "0" + Count02 + "CharacterLB").value)) : 0 ;
						ELE04 += (document.getElementById("ID0" + Count01 + "0" + Count02 + "Element").src.includes("PNG/UI/ELE04.png")) ? (0.25 * parseInt(document.getElementById("0" + Count01 + "0" + Count02 + "CharacterLB").value)) : 0 ;
					}
				if(ELE01 > 10) { ELE01 = 10; }
				if(ELE02 > 10) { ELE02 = 10; }
				if(ELE03 > 10) { ELE03 = 10; }
				if(ELE04 > 10) { ELE04 = 10; }
				document.getElementById("0" + Count01 + "ELE01Total").innerHTML = ELE01;
				document.getElementById("0" + Count01 + "ELE02Total").innerHTML = ELE02;
				document.getElementById("0" + Count01 + "ELE03Total").innerHTML = ELE03;
				document.getElementById("0" + Count01 + "ELE04Total").innerHTML = ELE04;
				Data.IdoMagELE01[Count01 - 1] = document.getElementById("0" + Count01 + "IdoMagELE01").value;
				...
				for(var Count02 = 1; Count02 < 5; Count02 ++)
					{
						...
						Data.CharacterSPD[(Count01 == 1) ? Count02 - 1 : Count02 + 3] = document.getElementById("0" + Count01 + "0" + Count02 + "CharacterSPD").value;
						Data.WeaponSPD[(Count01 == 1) ? Count02 - 1 : Count02 + 3] = document.getElementById("0" + Count01 + "0" + Count02 + "WeaponSPD").value;
						Data.SoulSPD[(Count01 == 1) ? Count02 - 1 : Count02 + 3] = document.getElementById("0" + Count01 + "0" + Count02 + "SoulSPD").value;
						Data.SupportSPD[(Count01 == 1) ? Count02 - 1 : Count02 + 3] = document.getElementById("0" + Count01 + "0" + Count02 + "SupportSPD").value;
						Data.IdoMagSPD[Count01 - 1] = document.getElementById("0" + Count01 + "IdoMagSPD").value;
						Data.IdoMagSPD01[Count01 - 1] = document.getElementById("0" + Count01 + "IdoMagSPD01").value;
						Data.IdoMagSPD02[Count01 - 1] = document.getElementById("0" + Count01 + "IdoMagSPD02").value;
						Data.IdoMagSPD03[Count01 - 1] = document.getElementById("0" + Count01 + "IdoMagSPD03").value;
						Data.IdoMagSPD04[Count01 - 1] = document.getElementById("0" + Count01 + "IdoMagSPD04").value;
					}
